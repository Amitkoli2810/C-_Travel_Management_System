...
public:
    ...
    void getDetails()
    {
        ofstream out("old-customer.txt",ios::app);    //open file using append mode to write customer details
        {
            cout<<"\n enter customer ID in number:"<<endl;
            cin>>cusID;
            cout<<"\n enter name:"<<endl;
            cin>>name;
            cout<<"\n enter age:"<<endl;
...
public:
    ...
    void cabDetails()
    {
        ...
        if(cabChoice==1)
        {
            ...
            {
                cout<<"invalid input! 9Redirecting to previous menu \n Please wait"<<endl;
                Sleep(1100);
                system("CLS");
                cabDetails();
            }
        ...
        else if(cabChoice==2)
        {
            ...
            {
                cout<<"Invalid Input! 8Redirecting to Previous menu \nPlease wait!"<<endl;
                Sleep(1100);
                system("CLS");
                cabDetails();
        ...
        {
            cout<<"Invalid input! 7Redirecting to Main Menu \n Please wait"<<endl;
            Sleep(1100);
            system("CLS");
            menu();
        }
...
public:
    ...
    void hotels()
    {
        ...
        if(choiceHotel==1)
        {
            ...
            {
                cout<<"Invalid Input! 6Redirecting to Previous Menu \n Please wait!"<<endl;
                Sleep(1100);
                system("CLS");
                hotels();
            }
        ...
        else if(choiceHotel==2)
        {
            ...
            {
                cout<<"Invalid Input! 5Redirecting to Previous Menu \n Please wait!"<<endl;
                Sleep(1100);
                system("CLS");
                hotels();
            }
        ...
        else if(choiceHotel==3)
        {
            ...
            {
                cout<<"Invalid Input!4Redirecting to Previous Menu \nPlease wait!"<<endl;
                Sleep(1100);
                system("CLS");
                hotels();
            }
        ...
        {
            cout<<"Invalid Input! 3Redirecting to Previous Menu \nPlease wait!"<<endl;
            Sleep(1100);
            system("CLS");
            menu();
...
void menu()
{
    ...
    if(mainChoice==1)
    {
        ...
        {
            cout<<"Invalid Input! 2Redirecting to Previous Menu \n Please wait!"<<endl;
            Sleep(1100);
            system("CLS");
            menu();
        }
    ...
    {
        cout<<"Invalid Input! 1Redirecting to Previous Menu \n Please WAit!"<<endl;
        Sleep(1100);
        system("CLS");
        menu();
    }
